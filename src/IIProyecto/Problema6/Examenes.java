...
public class Examenes {
    ...
    public Examenes(int nota, String nombreMateria, int puntosTotal, int puntosObtenidos, Date fecha) {
        this.nota = nota;
    ...
    public Examenes(String nombreMateria, int puntosTotal, Date fecha) {
        this.nombreMateria = nombreMateria;
        this.puntosTotal = puntosTotal;
        this.fecha = fecha;
    }
